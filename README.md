...
> _Add your headline metrics here, e.g.:_
> - **Accuracy:** XX%
> - **Macro F1:** XX%
> - **Precision / Recall (attack classes):** XX% / XX%
>
> Evaluation plots (confusion matrix, ROC, per-class precision/recall) are generated by `evaluate_and_plots.py` and saved to `/reports`.
